            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="http://localhost/HRSystem-CI/Projects/All_Tasks" class="text-white"><i class="" aria-hidden="true"></i>  Project List</a></button>
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="http://localhost/HRSystem-CI/Projects/All_Tasks" class="text-white"><i class="" aria-hidden="true"></i>  Field Visit</a></button>
                                            </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="table-responsive ">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                                                                       <tr>
                                                <td>Project X23...</td>
                                                <td>Demo Task Title for Testi...</td>
                                                <td>3rd of January 2022</td>
                                                <td>31st of January 2022</td>
                                                <td>
                                                                                                                                                <img src="http://localhost/HRSystem-CI/assets/images/users/Moo1402.png" height="40px" width="40px" style="border-radius:50px" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Liam">
                                                                                                <img src="http://localhost/HRSystem-CI/assets/images/users/user.png" height="40px" width="40px" style="border-radius:50px" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Will">
                                                                                                </td>
<!--                                                <td class="jsgrid-align-center ">
                                                    <a href="#" title="Edit" class="btn btn-sm btn-info waves-effect waves-light taskmodal" data-id=""><i class="fa fa-pencil-square-o"></i></a>
                                                    <a onclick="alert('Are you sure, you want to delete this?')" href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light TasksDelet" data-id=""><i class="fa fa-trash-o"></i></a>
                                                </td>-->
                                            </tr>
                                                                                    </tbody>
                                    </table>
                                    ...
                                    <div class="modal-body">
                                             <div class="form-group row">
                                                ...
                                                <select class="form-control custom-select col-md-8 proid" data-placeholder="Choose a Category" tabindex="1" name="projectid">
                                                                                                       <option value="1">Project X23</option>
                                                                                                       <option value="2">Multi User Chat System</option>
                                                                                                       <option value="3">Image Enhancement Software</option>
                                                                                                       <option value="4">Customer support service operation</option>
                                                                                                       <option value="5">Real Estate Site</option>
                                                                                                       <option value="6">Graphics Illustration</option>
                                                                                                   </select>
                                            </div>
                                            <div class="form-group row">
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".assetsstock").change(function (e) {
                                                ...
                                                $.ajax({
                                                    url: 'http://localhost/HRSystem-CI/logistice/GetInstock?id=' + this.value,
                                                    method: 'GET',
                                                    data: 'data',
